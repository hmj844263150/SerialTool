...
class Ui_EspRFtestTool(object):
    def setupUi(self, EspRFtestTool):
        ...
        self.leBTPayload.setGeometry(QtCore.QRect(20, 130, 101, 20))
    ...
    def retranslateUi(self, EspRFtestTool):
        ...
        self.label_14.setText(_translate("EspRFtestTool", "Data Type:", None))
        self.label_15.setText(_translate("EspRFtestTool", "DH Type:", None))
