...
class Ui_EspRFtestTool(object):
    def setupUi(self, EspRFtestTool):
        ...
        self.label_19 = QtGui.QLabel(self.tabBT)
        self.label_19.setGeometry(QtCore.QRect(20, 60, 101, 16))
        self.label_19.setObjectName(_fromUtf8("label_19"))
        self.cbBTUlap = QtGui.QComboBox(self.tabBT)
        self.cbBTUlap.setGeometry(QtCore.QRect(20, 80, 101, 22))
        self.cbBTUlap.setObjectName(_fromUtf8("cbBTUlap"))
        self.cbBTUlap.addItem(_fromUtf8(""))
        self.cbBTUlap.addItem(_fromUtf8(""))
        self.leUlap = QtGui.QLineEdit(self.tabBT)
        self.leUlap.setGeometry(QtCore.QRect(20, 80, 82, 22))
        self.leUlap.setMaxLength(100)
        self.leUlap.setObjectName(_fromUtf8("leUlap"))
        self.label_21 = QtGui.QLabel(self.tabBT)
        self.label_21.setGeometry(QtCore.QRect(150, 60, 101, 16))
        self.label_21.setObjectName(_fromUtf8("label_21"))
        self.cbBTItaddr = QtGui.QComboBox(self.tabBT)
        self.cbBTItaddr.setGeometry(QtCore.QRect(150, 80, 101, 22))
        self.cbBTItaddr.setObjectName(_fromUtf8("cbBTItaddr"))
        self.cbBTItaddr.addItem(_fromUtf8(""))
        self.cbBTItaddr.addItem(_fromUtf8(""))
        self.leItaddr = QtGui.QLineEdit(self.tabBT)
        self.leItaddr.setGeometry(QtCore.QRect(150, 80, 82, 22))
        self.leItaddr.setMaxLength(100)
        self.leItaddr.setObjectName(_fromUtf8("leItaddr"))
        ...
        self.cbBTDataRate.setGeometry(QtCore.QRect(20, 130, 161, 22))
    ...
    def retranslateUi(self, EspRFtestTool):
        ...
        self.lbBTPowerLevel.setText(_translate("EspRFtestTool", "Power Level:", None))
        ...
        self.label_19.setText(_translate("EspRFtestTool", "Ulap:", None))
        self.cbBTUlap.setItemText(0, _translate("EspRFtestTool", "0x6BC6967e", None))
        self.cbBTUlap.setItemText(1, _translate("EspRFtestTool", "custom", None))
        self.label_21.setText(_translate("EspRFtestTool", "Itaddr:", None))
        self.cbBTItaddr.setItemText(0, _translate("EspRFtestTool", "0x0", None))
        self.cbBTItaddr.setItemText(1, _translate("EspRFtestTool", "custom", None))
